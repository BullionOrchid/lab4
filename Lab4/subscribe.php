...
<body>
	...
	<main>
		<section>
			...
			// it should read, "Your email address, name@domain.com has been added to our list of subscribers." - use the $emailAddress variable and concatenate it inside the paragraph content -->
